    ...
    return (
        <div className='container'>
            ...
            <style jsx>{`
                ...
                /* Desktop */
                @media (min-width: 550px) { .container div { max-width: 90%; } }
                @media (min-width: 650px) { .container div { max-width: 80%; } }
                @media (min-width: 750px) { .container { align-items: flex-start; } .container div { text-align: start; } }
            `}</style>
        </div>
    )
}